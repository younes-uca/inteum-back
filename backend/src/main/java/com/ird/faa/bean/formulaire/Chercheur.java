...
public class Chercheur extends User {
    ...
    //public static final String GET_ALL_CHERCHEURS_NATIVE_QUERY =  "SELECT new Chercheur(ch.id, ch.credentialsNonExpired, ch.enabled, ch.createdAt, ch.updatedAt, ch.email, ch.accountNonExpired, ch.accountNonLocked, ch.username, ch.password, ch.prenom, ch.nom)";
    ...
    public Chercheur(Long id, boolean credentialsNonExpired, boolean enabled, Date createdAt, Date updatedAt, String email, boolean accountNonExpired, boolean accountNonLocked, String username, String password, String prenom, String nom) {
        super(id, credentialsNonExpired, enabled, createdAt, updatedAt, email, accountNonExpired, accountNonLocked, username, password, prenom, nom);
    }
