...
import com.ird.faa.service.chercheur.facade.EnseignementEtFormationChercheurService;
import com.ird.faa.service.chercheur.facade.EnseignementDisciplineScientifiqueChercheurService;
...
import com.ird.faa.service.chercheur.facade.EnseignementEnjeuxIrdChercheurService;
import com.ird.faa.service.chercheur.facade.NiveauEtudeEnseignementChercheurService;
import com.ird.faa.service.chercheur.facade.EtablissementEnseignementChercheurService;
import com.ird.faa.service.chercheur.facade.EnseignementPaysChercheurService;
import com.ird.faa.service.chercheur.facade.TypeEtudeEnseignementChercheurService;
import com.ird.faa.service.chercheur.facade.ModaliteEtudeChercheurService;
import com.ird.faa.service.chercheur.facade.EnseignementZoneGeographiqueChercheurService;
...
public List<Enseignement> findAll(){
        ...
        public List<Enseignement> findByEnseignementEtFormationId(Long id){
        	List<Enseignement> listEnseignement=enseignementDao.findByEnseignementEtFormationId(id);
        	List<Enseignement> listEnseignementWithAssociatedList=new ArrayList<>();
        	for(Enseignement enseignement:listEnseignement) {
        		Enseignement ens=findByIdWithAssociatedList(enseignement.getId());
        		listEnseignementWithAssociatedList.add(ens);
        	}
        	return listEnseignementWithAssociatedList;
        }
