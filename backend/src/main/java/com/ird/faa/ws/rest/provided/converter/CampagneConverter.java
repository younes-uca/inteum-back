...
public class CampagneConverter extends AbstractConverter<Campagne, CampagneVo> {
    ...
    public CampagneVo toVo(Campagne item) {
        ...
        if(this.campagneChercheurOuvertures && ListUtil.isNotEmpty(item.getCampagneChercheurOuvertures())){
        ...
        if(this.campagneChercheurFermetures && ListUtil.isNotEmpty(item.getCampagneChercheurFermetures())){
        ...
        if( this.campagneRelances && ListUtil.isNotEmpty(item.getCampagneRelances()) ){
        ...
        if(this.campagneRappels && ListUtil.isNotEmpty(item.getCampagneRappels()) ){
        ...
        if(this.distinctions && ListUtil.isNotEmpty(item.getDistinctions()) ){
        distinctionConverter.init(true);
        vo.setDistinctionsVo(distinctionConverter.toVo(item.getDistinctions()));
        }
        if(this.vieInstitutionnelle && ListUtil.isNotEmpty(item.getVieInstitutionnelles()) ){
        ...
        if(this.projetActiviteRecherches && ListUtil.isNotEmpty(item.getProjetActiviteRecherches()) ){
        ...
        if(this.instrumentsEtDispositifsIrds && ListUtil.isNotEmpty(item.getInstrumentsEtDispositifsIrds()) ){
        ...
        if(this.gestionEquipes && ListUtil.isNotEmpty(item.getGestionEquipes()) ){
        ...
        if(this.savoirEtInnovation && ListUtil.isNotEmpty(item.getSavoirEtInnovations()) ){
        ...
        if(this.cultureScientifique && ListUtil.isNotEmpty(item.getCultureScientifiques()) ){
        ...
        if(this.encadrement && ListUtil.isNotEmpty(item.getEncadrements()) ){
