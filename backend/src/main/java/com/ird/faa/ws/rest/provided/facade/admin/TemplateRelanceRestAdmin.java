...
public class TemplateRelanceRestAdmin {
	...
	@ApiOperation("Finds a templateRelance by code")
	@GetMapping("/code/{code}")
	public TemplateRelanceVo findByCode(@PathVariable String code) {
		return templateRelanceConverter.toVo(templateRelanceService.findByCode(code));
	}
