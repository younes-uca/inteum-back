...
public class ChercheurConverter extends AbstractConverter<Chercheur, ChercheurVo> {
    ...
    public ChercheurVo toVo(Chercheur item) {
        if (item == null) {
            ...
            if ( this.domaineScientifiqueChercheurs && ListUtil.isNotEmpty(item.getDomaineScientifiqueChercheurs())) {
            ...
            if (this.instrumentsEtDispositifsIrdChercheurs && ListUtil.isNotEmpty(item.getInstrumentsEtDispositifsIrdChercheurs()) ) {
